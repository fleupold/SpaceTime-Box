...
-(id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [_percentageLabel setFont:[UIFont fontWithName:@"Verdana" size:20]];
...
-(id)initWithProgressBarWith:(NSString *)message andTime:(NSInteger)seconds {
    ...
    if (self) {
        ...
        [_messageLabel setBackgroundColor:[UIColor clearColor]];
        [_messageLabel setTextColor:[UIColor whiteColor]];
        [_messageLabel setFont:[UIFont fontWithName:@"Verdana" size:20]];
        [_messageLabel setAdjustsFontSizeToFitWidth:YES];
        [self addSubview:_messageLabel];
        ...
        [_cancelLabel setFont:[UIFont fontWithName:@"Verdana" size:20]];
